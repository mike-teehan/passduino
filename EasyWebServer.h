...
This web server works on top of the WiFiClient class, defined in Ethernet.h.
...
class EasyWebServer {
  ...
  WiFiClient client;           // A reference to the WiFiClient object to work with.
  
  EasyWebServer(WiFiClient &client);  
    ~EasyWebServer();
...
EasyWebServer::EasyWebServer(WiFiClient &ec):client(ec){
